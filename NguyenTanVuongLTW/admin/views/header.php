<?php defined ('BASEPATH') or die('khong the truy cap vao trang nay!');?>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="../../index3.html" class="brand-link">
                <img src="../public/images/vuong.jpg" alt="AdminLTE Logo"
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="../public/images/vuongcute.jpg" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
