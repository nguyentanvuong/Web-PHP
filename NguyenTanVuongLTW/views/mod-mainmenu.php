...
<ul class="navbar-nav mr-auto text-info">
            <?php foreach($list_menu1 as $row_menu1): ?>
              ...
              <?php if(count($list_menu2)>0): ?>
                ...
                <a class="nav-link dropdown-toggle" href="<?php echo $row_menu1['link']; ?>" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
