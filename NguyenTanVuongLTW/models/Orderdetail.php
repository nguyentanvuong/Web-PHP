<?php
//Truy vấn dữ Dữ liệu bang orderdetail
class Orderdetail extends Database
{
    ...
    function orderdetail_list($args = [])
    {
        $strWhere = "";
        $strSort = "";
        $strLimit = "";
    ...
    function orderdetail_count($args = [])
    {
        $strWhere = "";
        $strSort = "";
        $strLimit = "";
    ...
    function orderdetail_update($data, $id)
    {
        $strset = "";
        foreach ($data as $f => $v) {
            $strset .= $f . "='$v', ";
